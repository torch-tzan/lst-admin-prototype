...
export const COURTS: Court[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80",
    description: "11F 屋上エリア・屋外ハード 4 面。夜間も照明完備。初心者から中級者におすすめ。",
  ...
  },
  {
    ...
    description: "2F 室内エリア・全天候型 2 面。空調完備で雨天も利用可能。",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1622279457486-28dc7d66b2f3?w=800&q=80",
    description: "3F プレミアム室内 3 面。観戦席・カフェ併設で試合観戦にも最適。",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&q=80",
    description: "4F 室内ハード 2 面。プロトーナメント仕様の床面。",
...
export const MEMBER_USERS: MemberUser[] = [
  {
    ...
    totalBookings: 28, totalSpend: 68400,
  },
  {
    ...
    totalBookings: 9, totalSpend: 22400,
  },
  {
    ...
    totalBookings: 62, totalSpend: 185200,
  },
  {
    ...
    totalBookings: 3, totalSpend: 7500,
  },
  {
    ...
    totalBookings: 14, totalSpend: 35600,
  },
  {
    ...
    totalBookings: 38, totalSpend: 102400,
  },
  {
    ...
    totalBookings: 8, totalSpend: 28800,
  },
  {
    ...
    totalBookings: 45, totalSpend: 126000,
  },
  {
  ...
  },
  {
    ...
    totalBookings: 22, totalSpend: 58800,
  },
  {
    ...
    totalBookings: 51, totalSpend: 156400,
  },
  {
    ...
    totalBookings: 7, totalSpend: 21000,
  },
  {
    ...
    totalBookings: 32, totalSpend: 89600,
  },
  {
  ...
  },
  {
    ...
    totalBookings: 11, totalSpend: 33500,
  },
];
...
export const COUPONS: Coupon[] = [
  {
    id: "cp-001", label: "累計利用額 ¥50,000 以上の会員へ春感謝クーポン",
    description: "累計利用額 ¥50,000 超の会員に 10% 割引",
...
// ─── キャンペーン・イベント ─────────────────────
/**
 * app の CampaignDetail 画面と完全一致する構造。
 * 詳細な参加条件・参加費・申込方法はすべて body に記載する。
 */
export const CAMPAIGNS: Campaign[] = [
  {
    id: "cm-001",
    title: "春のキャンペーン開催中",
    image: "https://images.unsplash.com/photo-1530259152377-3a014e1b0d2f?w=1200&q=80",
    body:
      "PADEL BASEでは、春の新規入会キャンペーンを実施中です！\n\n■ キャンペーン内容\n期間中に初回予約をされた方全員に、10%OFFクーポンをプレゼントいたします。\n\n■ 対象期間\n2026年3月1日〜4月30日\n\n■ 条件\n・期間中に初回のコート予約を完了すること\n・クーポンは予約完了後、自動的に付与されます\n\nこの機会にぜひPADEL BASEをお試しください！",
  ...
  },
  {
    id: "cm-004",
    title: "友達紹介キャンペーン",
    image: "https://images.unsplash.com/photo-1622279457486-28dc7d66b2f3?w=1200&q=80",
    body:
      "お友達をPADEL BASEに招待して、お互いにポイントをもらおう！\n\n■ キャンペーン内容\n招待した方・された方の両方に500ポイントをプレゼント！\n\n■ 参加方法\n1. マイページの「友達を招待」から招待リンクを取得\n2. お友達にリンクを共有\n3. お友達が会員登録を完了\n4. 両者にポイントが自動付与されます\n\n■ 注意事項\n・紹介人数の上限はありません\n・ポイントは登録完了後、即時付与されます\n・ポイントの有効期限は翌年末まで",
  ...
  },
  {
    id: "cm-005",
    title: "夏のナイター割引",
    image: "https://images.unsplash.com/photo-1627627256672-027a4613d028?w=1200&q=80",
    body:
      "夏の夜を楽しもう！ナイター割引キャンペーン実施中！\n\n■ キャンペーン内容\n18時以降のコート予約が15%OFF！\n\n■ 対象期間\n2026年6月1日〜8月31日\n\n■ 対象時間帯\n18:00〜22:00の予約\n\n■ 割引方法\n対象時間帯の予約時に自動適用されます。クーポンコードの入力は不要です。\n\n涼しい夜にパデルを楽しみましょう！",
  ...
  {
    id: "cm-007",
    title: "バレンタイン 2026 キャンペーン（終了）",
    body:
      "2 月限定 20% OFF（終了）",
    dateLabel: "2026/02/10 〜 2026/02/20",
    scope: "platform",
    status: "ended",
    createdBy: "運営管理者",
...
export const ADMIN_ACCOUNTS: AdminAccount[] = [
  ...
  // 企業 v1 オーナー・マネージャー
  {
    ...
    roleKey: "venue-owner", venueId: "v1", status: "active",
  ...
  },
  {
    ...
    roleKey: "venue-manager", venueId: "v1", status: "active",
  ...
  // 企業 v2
  {
    ...
    roleKey: "venue-owner", venueId: "v2", status: "active",
  ...
  },
  {
    ...
    roleKey: "venue-manager", venueId: "v2", status: "active",
...
export const ADMIN_ROLES: AdminRole[] = [
  {
    ...
    description: "プラットフォーム全体の最高権限。全モジュールの CRUD と全機微操作。",
    ...
    specialPerms: [
      "coach.approve", "coach.suspend",
      "booking.approve_reschedule", "booking.refund",
      "payment.retry", "finance.export",
      "coupon.distribute", "announcement.send",
      "user.points_adjust", "user.suspend", "venue.suspend",
    ],
  },
  {
    id: "role-lst-operations", key: "lst-operations",
    label: "運営担当", scope: "lst",
    description: "日常運営：コーチ審査、お知らせ、クーポン配布。システム・手数料は閲覧のみ。",
    builtin: true, createdAt: "2025-01-01",
    modulePerms: {
      user: ["read", "update"],
      venue: ["read", "update"],
      ...
      equipment: ["read"],
      finance: ["read"],
      coupon: ["read", "create", "update"],
      points: ["read"],
      announcement: ["read", "create", "update"],
    ...
    specialPerms: [
      ...
      "coupon.distribute",
      "announcement.send",
      "user.points_adjust", "user.suspend",
    ],
  },
  {
    id: "role-lst-finance", key: "lst-finance",
    label: "財務担当", scope: "lst",
    description: "財務特化：売上・決済・手数料・出金エラー再送。",
    builtin: true, createdAt: "2025-01-01",
    modulePerms: {
      user: ["read"],
      venue: ["read"],
    ...
    specialPerms: ["payment.retry", "finance.export"],
  },
  {
    id: "role-lst-support", key: "lst-support",
    label: "カスタマーサポート", scope: "lst",
    description: "利用者対応：会員情報・予約振替・返金・ポイント調整。",
    builtin: true, createdAt: "2025-01-01",
    modulePerms: {
      user: ["read", "update"],
      venue: ["read"],
  ...
  },
  {
    ...
    description: "閲覧と基本操作のみ：予約確認、振替審査、備品在庫更新。",
    builtin: true, createdAt: "2025-01-01",
    modulePerms: {
      booking: ["read"],
      court: ["read"],
    ...
    specialPerms: ["booking.approve_reschedule"],
  },
];
